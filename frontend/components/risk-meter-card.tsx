...
export function RiskMeterCard({ riskData, className = '' }: RiskMeterCardProps) {
  ...
  return (
    <div className={`flex flex-col items-center rounded-lg border border-border bg-secondary/30 p-6 ${className}`}>
      <h3 className="mb-6 font-semibold text-white">Risk Assessment</h3>
      ...
      <div className="w-full space-y-3 text-center">
        <p className="text-sm font-semibold text-white">{getRiskLabel()}</p>
        <p className="text-xs leading-relaxed text-muted-foreground">{riskData.description}</p>
        <div className="pt-2">
          <span
